...
defmodule BrettProjekt.Game do
  ...
  ## Examples
      ...
      iex> {:ok, game} = BrettProject.Game.create System.unique_integer # Should be generated by the GameManager
      iex> BrettProject.Game.join_enabled? game
      true
      iex> BrettProject.Game.disable_join game
      iex> BrettProject.Game.join_enabled? game
      false
